...
Early-career, but grounded in academic proof and research standards.  
ECE + AIML → MS CS at GSU; I build with an industry mindset and want to scale real products and services.
...
| Project | Repo |
|---------|------|
| NLQ Chatbot over Database | [nlq-chatbot](https://github.com/mkm-007/nlq-chatbot) |
| Document Abstraction with LLM (RAG) | [doc-abstraction-llm](https://github.com/mkm-007/doc-abstraction-llm) |
